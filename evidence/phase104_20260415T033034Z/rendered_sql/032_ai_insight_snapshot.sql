SELECT
  ...
  CASE WHEN EXISTS (SELECT 1 FROM `prj-maq-workcaptain-nonprod.workcaptain_analytics.mart_funnel_steps` LIMIT 1) THEN 'Funnel coverage is available for conversion analysis.' ELSE 'Funnel coverage is not yet available.' END AS funnel_interpretation,
