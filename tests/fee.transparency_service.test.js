...
const MATRIX_PATH = path.join(__dirname, '../app/config/payments/psp_routing_matrix_v1.json')
...
describe('Suite 5: PSP routing matrix schema', () => {
  it('matrix file exists at app/config/payments/psp_routing_matrix_v1.json', () => {
    const fs = require('fs')
    assert.ok(fs.existsSync(MATRIX_PATH), 'psp_routing_matrix_v1.json must exist')
  })
