...
const MATRIX_PATH = path.join(__dirname, '../../config/payments/fee_transparency_policy_v1.json')
 ...
 * @param {string}  paymentMethodId   - One of the IDs in fee_transparency_policy_v1.json
